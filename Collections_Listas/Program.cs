...

{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"A primeira aula que contem a palavra 'trabalhando' no titulo é: " +
                $"{aulas.First(aula => aula.Contains("Trabalhando"))}");

            Console.WriteLine($"A última aula que contem a palavra 'trabalhando' no titulo é: " +
                $"{aulas.Last(aula => aula.Contains("Trabalhando"))}");

            Console.WriteLine($"A primeira aula que contem a palavra 'Conclusão' no titulo é: " +
